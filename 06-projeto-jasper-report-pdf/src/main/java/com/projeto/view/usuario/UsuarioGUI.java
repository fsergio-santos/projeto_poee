...
public class UsuarioGUI extends JDialog {
	...
	private void initComponents() {
		...
		panel.setBounds(674, 346, 142, 58);
		...
		btnNewButton.setIcon(new ImageIcon(UsuarioGUI.class.getResource("/com/projeto/estrutura/imagens/pdf.png")));
		btnNewButton.setBounds(31, 7, 81, 39);
