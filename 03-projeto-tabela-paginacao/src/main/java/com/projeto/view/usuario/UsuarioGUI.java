					...
					.addGroup(gl_contentPane.createParallelGroup(Alignment.LEADING)
						...
						.addGroup(gl_contentPane.createSequentialGroup()
							.addGroup(gl_contentPane.createParallelGroup(Alignment.LEADING)
								...
								.addGroup(gl_contentPane.createSequentialGroup()
									.addGroup(gl_contentPane.createParallelGroup(Alignment.LEADING)
										.addComponent(passwordFieldSenha, GroupLayout.DEFAULT_SIZE, 529, Short.MAX_VALUE)
										.addComponent(textFieldNome, GroupLayout.DEFAULT_SIZE, 529, Short.MAX_VALUE)
										.addComponent(textFieldEmail, GroupLayout.DEFAULT_SIZE, 529, Short.MAX_VALUE))
